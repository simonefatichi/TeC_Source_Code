...
[Ts,Pr_sno,Pr_liq,Ws_under,Csno,Cice,Cfol_H,Cfol_L,CLitter,NDVI,rb_H,rb_L,rs_sunH,rs_sunL,rs_shdH,rs_shdL,r_litter,...
    ...
    G,Gfin,Tdp,Oint,Oice,Tdamp,Tdeb,Tice,SWE,SND,ros,In_SWE,SP_wc,WR_SP,U_SWE,NIn_SWE,dQ,Qfm,t_sls,DQ,DT,...
...
FROCK = FROCKtm1 + Lk + Lk_wat + Lk_rock + Crock*sum(Qi_in)*dth; %%[mm]
%%%% Total Horton Runoff
