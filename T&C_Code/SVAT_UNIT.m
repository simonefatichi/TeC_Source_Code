...
function[Ts,Pr_sno,Pr_liq,Ws_under,Csno,Cice,Cfol_H,Cfol_L,CLitter,NDVI,rb_H,rb_L,rs_sunH,rs_sunL,rs_shdH,rs_shdL,r_litter,...
    ...
    In_max_urb,In_max_rock,tau_snotm1,Ws_undertm1,...
...
%%% Updated Snow Albedo
if Csno > 0
    [snow_alb,tau_sno,e_sno]=Albedo_Snow_Properties(dt,SWE,h_S,Ts,SWEtm1,tau_snotm1,snow_albtm1,Th_Pr_sno,Pr_sno_day);
else
