...
function[H,QE,Qv,T_H,T_L,EIn_H,EIn_L,EG,ESN,ESN_In,EWAT,ELitter,EICE,EIn_urb,EIn_rock]=Heat_fluxes(dt,...
...
Qv = cw*Pr_liq*row*(max(Ta,0)-Ts) + ci*Pr_sno*row*(min(Ta,0)-Ts)  ; %% [W/m^2] Advected Heat Flux in Precipiation 
%%%%%%%%%%
end 