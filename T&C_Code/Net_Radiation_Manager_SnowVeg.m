...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[Rnet]=Net_Radiation_Manager_SnowVeg(Ts,TsV,Latm,SvF,...
...
Tg=Ts;    TvHsun=TsV;  TvHshd=TsV;
TvLsun=TsV; TvLshd=TsV; Tsno=Ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% Incoming Longwave  %%%%%%%%%%%
...
Rnet_wat = Cwat*(Rabsb_wat + Labsb_wat)*(1-Csnow)*(1-Cicew);
Rnet_rock = Crock*(Rabsb_rock +Labsb_rock)*(1-Csno)*(1-Cice);
Rnet_ice =  Cice*(Rabsb_ice + Labsb_ice)*(1-Csno)*(1-sum(Ccrown)-Cwat) + Cicew*(Rabsb_ice + Labsb_ice)*Cwat;
...
%%% NET RADIATION [W/m^2]
Rnet = Rnet_ground + Rnet_vegH + Rnet_vegL + Rnet_snow + Rnet_rock +Rnet_wat + Rnet_urb + Rnet_ice;
%%%%%%%%%%%%%%%%%%%%%%%
return